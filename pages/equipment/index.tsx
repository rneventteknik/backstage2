...
import { EquipmentApiModel, IEquipmentCategoryApiModel } from '../../interfaces/api-models';
...
const fetcher = (url: string) =>
    fetch(url)
        .then((response) => getResponseContentOrError<EquipmentApiModel[]>(response))
        .then((apiModel) => apiModel.map((x) => toEquipment(x)));
