...
export const toEquipmentListEntryObjectionModel = (
    ...
    return {
        ...
        id: clientModel.id,
        equipment: undefined,
        equipmentId: clientModel.equipment === null ? null : clientModel.equipment?.id,
        equipmentPrice: undefined,
        equipmentPriceId: clientModel.equipmentPrice === null ? null : clientModel.equipmentPrice?.id,
