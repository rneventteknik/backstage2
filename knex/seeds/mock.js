    ...
    const firstEquipmentListId = await knex('EquipmentList')
        .insert([
            ...
            //Konferens - Trädkramarna AB
            {
                ...
                created: getVarianceDateString(-100),
                updated: getVarianceDateString(100),
                equipmentOutDatetime: new Date().setCustomTime().addDays(30).toISOString(),
                equipmentInDatetime: new Date().setCustomTime().addDays(32).toISOString(),
                usageStartDatetime: new Date().setCustomTime().addDays(30).toISOString(),
                usageEndDatetime: new Date().setCustomTime().addDays(32).toISOString(),
                bookingId: bookingIds.konferens,
            },
            {
                name: 'Video',
