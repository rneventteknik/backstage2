...
export async function seed(knex) {
    ...
    const bookingIds = {
        ...
        lunchföreläsningBjörk: firstBookingId + 8,
        lunchföreläsningTall: firstBookingId + 9,
        lunchföreläsningEk: firstBookingId + 10,
        lunchföreläsningFuru: firstBookingId + 11,
    };
    ...
    const firstEquipmentListId = await knex('EquipmentList')
        .insert([
            ...
            //Konferens - Trädkramarna AB
            {
                ...
                created: getVarianceDateString(-100),
                updated: getVarianceDateString(100),
                equipmentOutDatetime: '2022-05-04 08:00:00',
                equipmentInDatetime: '2022-05-05 17:00:00',
                usageStartDatetime: '2022-05-04 12:00:00',
                usageEndDatetime: '2022-05-05 14:00:00',
                bookingId: bookingIds.konferens,
            },
            {
                name: 'Video',
